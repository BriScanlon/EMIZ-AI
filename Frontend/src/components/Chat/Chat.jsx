...
import {urlChats} from "../../services/api"
...
// import GraphIcon from "../../ui/GraphIcon/UiIcon";
// import { Link } from "react-router-dom";
// import { getChats } from "../../services/api"; // Updated import
...
//         setMessages(response.chats.map(chat => ({ text: chat, sender: "bot", timestamp: new Date() })));
//       } catch (error) {
